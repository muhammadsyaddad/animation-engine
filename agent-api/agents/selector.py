...
from agents.animation_agent import get_animation_agent
...
def get_agent(
    ...
    elif agent_id == AgentType.ANIMATION_AGENT:
        return get_animation_agent(model_id=model_id, user_id=user_id, session_id=session_id, debug_mode=debug_mode)
